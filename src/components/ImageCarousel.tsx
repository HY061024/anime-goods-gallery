...
export default function ImageCarousel({ images, type, onImageClick }: ImageCarouselProps) {
  ...
  if (images.length === 0) {
    return (
      <div className="rounded-3xl bg-white shadow-sm border border-pink-100">
        <div className="flex aspect-[4/3] w-full flex-col items-center justify-center bg-slate-50 text-slate-400 sm:h-[420px] max-sm:h-[300px]">
  ...
  return (
    <div className="rounded-3xl bg-white shadow-sm border border-pink-100 overflow-hidden">
      {/* 标签 + 计数 */}
      ...
      {/* 图片区域 */}
      <div
        className="relative bg-slate-100 sm:h-[420px] max-sm:h-[300px] flex items-center justify-center cursor-pointer select-none"
