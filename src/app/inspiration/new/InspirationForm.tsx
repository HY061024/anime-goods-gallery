...
export default function InspirationForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6 space-y-5">
      ...
      <button type="submit" disabled={isPending} className="w-full rounded-xl bg-pink-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-pink-600 disabled:opacity-50">
        {isPending ? "发布中…" : "发布"}
      </button>
    </form>
  );
