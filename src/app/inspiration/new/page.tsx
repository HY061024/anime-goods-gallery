  ...
  if (!user) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-8">
        ...
        <div className="mt-12 rounded-3xl bg-white p-12 text-center shadow-sm ring-1 ring-gray-100">
          ...
          <h1 className="mt-4 text-xl font-bold text-gray-900">登录后可发布灵感</h1>
          <p className="mt-2 text-gray-500">分享你的二次元周边心得、测评、视频和素材</p>
